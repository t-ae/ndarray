...
def main():
    ...
    for i in range(3001):
        ...
        d_out_W2 = np.matmul(d_h2_1_W2.reshape([numTrainSamples, numHiddenUnits1, 1]),
                             d_out_h2_1.reshape([numTrainSamples, 1, numOutput])) # [90, 5, 3]
        ...
        d_out_W1 = np.matmul(d_h1_1_W1.reshape([numTrainSamples, numFeatures, 1]),
                             d_out_h1_1.reshape([numTrainSamples, 1, numHiddenUnits1])) # [90, 4, 5]
